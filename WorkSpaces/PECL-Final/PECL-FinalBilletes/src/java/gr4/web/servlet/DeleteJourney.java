...
public class DeleteJourney extends HttpServlet {
    ...
    private String url     =  "/admin/data-journey.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final int id_viaje  = Integer.valueOf(request.getParameter("id-viaje"));
        this.status         = new Trayectos(conexion).deleteTrayecto(id_viaje);
