 ...
 * @author david
 */
public class PayOneFlyCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        final int id_vuelo  = Integer.valueOf(request.getParameter("id-vuelo"));
        ServletContext ctx  = request.getServletContext();
        car                 = (Carrito)request.getSession(true).getAttribute("carro");
        String username     = null;
        if (car != null) {
            Carrito.Vuelos vuelo = car.getBillete(id_vuelo);
            ...
            if (vuelo != null) {
                final int num_billetes = vuelo.getNum_bille();
                final int id_billete   = vuelo.getId_vuelo();
                ArrayList<String[]> meta_bill = new Comprar((Connection) ctx.getAttribute("conexion")).validateOneComprar(id_billete, num_billetes, username);
