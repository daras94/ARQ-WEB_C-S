 ...
 * @author david
 */
public class AddVueloCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final int num_bille = Integer.valueOf(request.getParameter("num-billetes"));
        car = (Carrito)request.getSession(true).getAttribute("carro");
        if (car == null) {
            car = new Carrito(); 
        }
        car.addProducto(id_vuelo, num_bille);
