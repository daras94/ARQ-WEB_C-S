...
habiendose logueado como un adminitrador con un usuario que pose ROLE_ADMIN en 
la BD.     
...
pose la corespondiente rol de administrador.
    ...
    - Todos los jsp y subdirectorios con jspps que se cren en esta ruta seran 
      ...
      rios des la carpeta "admin" de forma que si tenemos el siguiente arbol
      de directorios:
      ...
      enten forma:
        ...
        - http://localhost:8080/PECL-FinalBilletes/admin/dir1/p1.html
        - http://localhost:8080/PECL-FinalBilletes/admin/dir1/p2.html

        - http://localhost:8080/PECL-FinalBilletes/admin/dir2/p11.html
        - http://localhost:8080/PECL-FinalBilletes/admin/dir2/p21.html
